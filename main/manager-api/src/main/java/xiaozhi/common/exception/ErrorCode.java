...
/**
 * Error codes, composed of 5 digits, first 2 digits for module code, last 3 digits for business code
 * <p>
 * For example: 10001 (10 represents system module, 001 represents business code)
 * </p>
...
public interface ErrorCode {
    ...
    int UPDATE_DATA_FAILED = 10066; // Update data failed
    ...
    int RETRIEVE_PASSWORD_DISABLED = 10073; // Password retrieval not enabled
    ...
    int DICT_TYPE_DUPLICATE = 10077; // Dictionary type code duplicate

    // Resource processing error codes
    int RESOURCE_READ_ERROR = 10078; // Failed to read resource

    // Agent related error codes
    int LLM_INTENT_PARAMS_MISMATCH = 10079; // LLM model and Intent recognition parameter selection mismatch

    // Voiceprint related error codes
    int VOICEPRINT_ALREADY_REGISTERED = 10080; // This voice voiceprint already registered
    ...
    int VOICEPRINT_UPDATE_ADMIN_ERROR = 10083; // Error modifying voiceprint, please contact administrator
    int VOICEPRINT_API_URI_ERROR = 10084; // Voiceprint API URI error
    ...
    int LLM_NOT_EXIST = 10092; // Configured LLM does not exist
    int MODEL_REFERENCED_BY_AGENT = 10093; // This model configuration is referenced by an agent and cannot be deleted
    int LLM_REFERENCED_BY_INTENT = 10094; // This LLM model is referenced by intent recognition configuration and cannot be deleted
    ...
    int WEBSOCKET_URL_FORMAT_ERROR = 10100; // WebSocket address format incorrect
    ...
    int OTA_INTERFACE_FORMAT_ERROR = 10107; // OTA interface return content format incorrect
    ...
    int MCP_INTERFACE_FORMAT_ERROR = 10113; // MCP interface return content format incorrect
    ...
    int VOICEPRINT_INTERFACE_FORMAT_ERROR = 10120; // Voiceprint interface return content format incorrect
    ...
    int MQTT_SECRET_LENGTH_INSECURE = 10123; // MQTT secret length insecure
    ...
    int VOICE_RESOURCE_NO_PERMISSION = 10150; // You don't have permission to operate this record
    ...
    int VOICE_CLONE_HUOSHAN_CONFIG_MISSING = 10155; // Volcengine (Huoshan) configuration missing
    ...
    int VOICE_CLONE_HUOSHAN_VOICE_ID_ERROR = 10160; // Volcengine voice ID format error
    ...
    int RAG_API_ERROR = 10167; // RAG API call failed
    int UPLOAD_FILE_ERROR = 10168; // Upload file failed
    int NO_PERMISSION = 10169; // No permission
    int KNOWLEDGE_BASE_NAME_EXISTS = 10170; // Knowledge base name already exists
    int RAG_API_ERROR_URL_NULL = 10171; // RAG configuration base_url cannot be empty, please complete configuration
    int RAG_API_ERROR_API_KEY_NULL = 10172; // RAG configuration api_key cannot be empty, please complete configuration
    int RAG_API_ERROR_API_KEY_INVALID = 10173; // RAG configuration api_key contains placeholder, please replace with actual API key
    int RAG_API_ERROR_URL_INVALID = 10174; // RAG configuration base_url format incorrect, please check protocol
    int RAG_DATASET_ID_NOT_NULL = 10176; // RAG configuration dataset_id cannot be empty
    int RAG_MODEL_ID_NOT_NULL = 10177; // RAG configuration model_id cannot be empty
    int RAG_DATASET_ID_AND_MODEL_ID_NOT_NULL = 10178; // RAG configuration dataset_id and model_id cannot be empty
    ...
    // Agent template error codes (supplement)
    ...
    int OTA_UPLOAD_COUNT_EXCEED = 10195; // OTA upload count exceeded limit
