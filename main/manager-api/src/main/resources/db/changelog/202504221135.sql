...
('TTS_EdgeTTS0007', 'TTS_EdgeTTS', 'EdgeTTS Female - Liaoning Xiaobei', 'zh-CN-liaoning-XiaobeiNeural', 'Liaoning Dialect', NULL, NULL, 1, NULL, NULL, NULL, NULL),
('TTS_EdgeTTS0008', 'TTS_EdgeTTS', 'EdgeTTS Female - Shaanxi Xiaoni', 'zh-CN-shaanxi-XiaoniNeural', 'Shaanxi Dialect', NULL, NULL, 1, NULL, NULL, NULL, NULL),
...
INSERT INTO `ai_tts_voice` VALUES ('TTS_DoubaoTTS0003', 'TTS_DoubaoTTS', 'Cheerful Young Man', 'BV056_streaming', 'Mandarin', 'https://lf3-speech.bytetos.com/obj/speech-tts-external/portal/Portal_Demo_BV056.mp3', NULL, 4, NULL, NULL, NULL, NULL);
INSERT INTO `ai_tts_voice` VALUES ('TTS_DoubaoTTS0004', 'TTS_DoubaoTTS', 'Cute Baby Voice', 'BV051_streaming', 'Mandarin', 'https://lf3-speech.bytetos.com/obj/speech-tts-external/portal/Portal_Demo_BV051.mp3', NULL, 5, NULL, NULL, NULL, NULL);
...
-- Fix CosyVoice Siliconflow voices
...
INSERT INTO `ai_tts_voice` VALUES ('TTS_MinimaxTTS0001', 'TTS_MinimaxTTS', 'Minimax Young Girl Voice', 'female-shaonv', 'Chinese', NULL, NULL, 8, NULL, NULL, NULL, NULL);

-- Alibaba Cloud TTS voices
delete from `ai_tts_voice` where id = 'TTS_AliyunTTS0001';
INSERT INTO `ai_tts_voice` VALUES ('TTS_AliyunTTS0001', 'TTS_AliyunTTS', 'Alibaba Cloud Xiaoyun', 'xiaoyun', 'Chinese', NULL, NULL, 9, NULL, NULL, NULL, NULL);
