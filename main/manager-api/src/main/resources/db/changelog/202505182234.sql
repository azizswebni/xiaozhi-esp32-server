-- Add parameters needed for mobile SMS registration feature
...
(112, 'server.sms_max_send_count', '10', 'number', 1, 'Maximum SMS messages per number per day', NULL, NULL, NULL, NULL),
(610, 'aliyun.sms.access_key_id', '', 'string', 1, 'Alibaba Cloud access_key', NULL, NULL, NULL, NULL),
(611, 'aliyun.sms.access_key_secret', '', 'string', 1, 'Alibaba Cloud access_key_secret', NULL, NULL, NULL, NULL),
...
update sys_params set remark = 'Whether to allow non-admin users to register' where param_code = 'server.allow_user_register';

-- Add mobile area code dictionary
...
(102, 'MOBILE_AREA', 'Mobile Area', 'Mobile area code dictionary', 0, 1, NOW(), 1, NOW());
