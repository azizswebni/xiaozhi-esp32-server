...
INSERT INTO `ai_model_config` VALUES ('ASR_Qwen3Flash', 'ASR', 'Qwen3-ASR-Flash', 'Qianwen Speech Recognition Service', 0, 1, '{"type": "qwen3_asr_flash", "api_key": "", "base_url": "https://dashscope.aliyuncs.com/compatible-mode/v1", "model_name": "qwen3-asr-flash", "output_dir": "tmp/", "enable_lid": true, "enable_itn": true}', 'https://help.aliyun.com/zh/bailian/', 'Supports multi-language recognition, singing recognition, and noise rejection', 20, NULL, NULL, NULL, NULL);
...
`remark` = 'Qianwen Qwen3-ASR-Flash Configuration Guide:
...
3. Qwen3-ASR-Flash is based on the Qianwen multimodal foundation model, supporting multi-language recognition, singing recognition, noise rejection and other features
