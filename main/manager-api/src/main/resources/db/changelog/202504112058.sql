-- This file initializes system parameter data, no manual execution needed, it runs automatically on project startup
-- --------------------------------------------------------
...
INSERT INTO `sys_params` (id, param_code, param_value, value_type, param_type, remark) VALUES (310, 'wakeup_words', 'Hi Xiaozhi;Hello Xiaozhi;Hey Xiaoai;Hello Xiaoxin;Hi Xiaoxin;Hey Xiaomei;Xiaolong Xiaolong;Hey Miaomiao;Xiaobin Xiaobin;Xiaobing Xiaobing', 'array', 1, 'Wake word list, used for wake word recognition');
