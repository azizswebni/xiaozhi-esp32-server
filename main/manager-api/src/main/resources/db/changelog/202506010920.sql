...
3. Enter the key in the configuration file' WHERE `id` = 'VLLM_ChatGLMVLLM';
...
INSERT INTO `sys_params` (id, param_code, param_value, value_type, param_type, remark) VALUES (114, 'server.vision_explain', 'null', 'string', 1, 'Vision analysis interface address, sent to devices, multiple addresses separated by ;');
