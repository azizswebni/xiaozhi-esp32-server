...
1. You need to apply for a Minimax API Key first
2. You need to fill in the Group ID
...
5. Supports custom pronunciation dictionary and timbre weights
6. Hidden parameter configuration: Voice Setting (voice_setting), Pronunciation Dictionary (pronunciation_dict), Timbre Weights (timber_weights)
   - Speed (speed): Range [0.5,2], default 1.0, higher value means faster speed
   - Volume (vol): Range (0,10], default 1.0, higher value means louder volume
   - Pitch (pitch): Range [-12,12], default 0, value must be an integer
   - Emotion (emotion): Controls the emotion of synthesized speech, supports 7 values: ["happy", "sad", "angry", "fearful", "disgusted", "surprised", "calm"], this parameter only works for speech-2.5-hd-preview, speech-2.5-turbo-preview, speech-02-hd, speech-02-turbo, speech-01-turbo, speech-01-hd
   - timbre_weights and voice_id are mutually exclusive, one must be filled
   - voice_id (the requested voice ID, must be filled together with the weight parameter)
...
INSERT INTO `ai_tts_voice` VALUES ('TTS_MinimaxStreamTTS_0005', 'TTS_MinimaxStreamTTS', 'Innocent Junior Boy', 'chunzhen_xuedi', 'Chinese', NULL, NULL, NULL, NULL, 5, NULL, NULL, NULL, NULL);
INSERT INTO `ai_tts_voice` VALUES ('TTS_MinimaxStreamTTS_0006', 'TTS_MinimaxStreamTTS', 'Cool Senior Boy', 'lengdan_xiongzhang', 'Chinese', NULL, NULL, NULL, NULL, 6, NULL, NULL, NULL, NULL);
...
INSERT INTO `ai_tts_voice` VALUES ('TTS_MinimaxStreamTTS_0009', 'TTS_MinimaxStreamTTS', 'Charming Elegant Female', 'wumei_yujie', 'Chinese', NULL, NULL, NULL, NULL, 9, NULL, NULL, NULL, NULL);
INSERT INTO `ai_tts_voice` VALUES ('TTS_MinimaxStreamTTS_0010', 'TTS_MinimaxStreamTTS', 'Cute Junior Girl', 'diadia_xuemei', 'Chinese', NULL, NULL, NULL, NULL, 7, NULL, NULL, NULL, NULL);
