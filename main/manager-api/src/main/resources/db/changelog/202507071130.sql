...
-- Update Alibaba Cloud streaming ASR configuration instructions
UPDATE `ai_model_config` SET
`doc_link` = 'https://nls-portal.console.aliyun.com/',
`remark` = 'Alibaba Cloud Streaming ASR Configuration Instructions:
1. The difference between Alibaba Cloud ASR and Alibaba Cloud (Streaming) ASR is: Alibaba Cloud ASR is one-time recognition, Alibaba Cloud (Streaming) ASR is real-time streaming recognition
...
4. Supports Chinese real-time speech recognition, with punctuation prediction and inverse text normalization
...
5. The max_sentence_silence parameter controls the sentence break detection time (milliseconds), default is 800ms
