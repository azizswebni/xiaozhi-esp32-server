...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        introduce: [
          { required: true, message: this.$t('voicePrintDialog.descriptionRequired'), trigger: "blur" }
        ],
        sourceName: [
          { required: true, message: this.$t('voicePrintDialog.nameRequired'), trigger: "blur" }
        ],
        audioId: [
          { required: true, message: this.$t('voicePrintDialog.audioVectorRequired'), trigger: "change" }
        ]
      }
    };
  },
