...
export default {
    ...
    methods: {
        ...
        async handleFileChange(file) {
            ...
            // Enter step 2 first, ensure DOM is rendered
            this.currentStep = 2;

            // Wait for DOM update before loading audio
            await this.$nextTick();
        ...
        drawWaveform() {
            ...
            this.waveformData.forEach((value, index) => {
                // Normalize and scale, using 80% of height
        ...
        async uploadAudio() {
            ...
            // Validate audio duration (8-60 seconds)
            if (this.audioBuffer) {
                const duration = this.audioBuffer.duration;
