export default {
  ...
  // 工具帮助文本
  "mcpToolCall.help.getDeviceStatus":
    "查看设备的当前运行状态，包括音量、屏幕、电池等信息。",
  "mcpToolCall.help.setVolume": "调整设备的音量大小，请输入0-100之间的数值。",
  "mcpToolCall.help.setBrightness":
    "调整设备屏幕的亮度，请输入0-100之间的数值。",
  "mcpToolCall.help.setTheme":
    "切换设备屏幕的显示主题，可以选择浅色或深色模式。",
  "mcpToolCall.help.takePhoto":
    "使用设备摄像头拍摄照片并进行识别分析，请输入要询问的问题。",
  "mcpToolCall.help.getSystemInfo":
    "获取设备的系统信息，包括硬件规格、软件版本等。",
  "mcpToolCall.help.reboot": "重启设备，执行后设备将重新启动。",
  "mcpToolCall.help.upgradeFirmware":
    "从指定URL下载并升级设备固件，升级后设备会自动重启。",
  "mcpToolCall.help.getScreenInfo":
    "获取屏幕的详细信息，如分辨率、尺寸等参数。",
  ...
  "manualAddDeviceDialog.invalidMacAddress":
  ...
  "chatHistory.downloadCurrentWithPreviousSessions":
    "下载本会话及前20条会话聊天记录",
  ...
  "cache.swCheckMethod1":
    "在开发者工具的Application/Application标签页中查看Service Worker状态",
  "cache.swCheckMethod2":
    "在开发者工具的Application/Cache/Cache Storage中查看缓存内容",
  "cache.swCheckMethod3":
    "使用生产构建(npm run build)并通过HTTP服务器访问以测试完整功能",
  ...
  "cache.swNotSupported":
    "当前浏览器不支持Service Worker，CDN资源缓存功能不可用",
  ...
  "dictManagement.confirmBatchDeleteDictData":
    "确定要删除选中的{count}个字典数据吗?",
  ...
  "paramManagement.confirmBatchDelete":
    "确定要删除选中的{paramCount}个参数吗？",
  ...
  "paramManagement.updateSuccess":
    "修改成功，部分配置需重启xiaozhi-server模块才生效",
  ...
  "functionDialog.pleaseSelectFunctionForParam":
    "请选择已配置的功能进行参数设置",
  ...
  "modelConfig.setDefaultSuccess":
    "设置默认模型成功，请及时手动重启xiaozhi-server模块",
  ...
  "modelConfigDialog.enterJsonExample":
    '请输入JSON格式变量(示例:{"key":"value"})',
  ...
  "ttsModel.voiceCodeNameLanguageRequired":
    "音色编码、音色名称和语言类型不能为空",
  ...
  "providerDialog.confirmBatchDeleteFields":
    "确定要删除选中的{count}个字段吗？",
  ...
  "knowledgeBaseManagement.selectKnowledgeBaseFirst":
    "请先选择需要删除的知识库",
  "knowledgeBaseManagement.confirmBatchDelete":
  ...
  "knowledgeBaseDialog.namePlaceholder":
    "请精确输入知识库名称，才能提高调用知识库的精准性",
  ...
  "knowledgeBaseDialog.namePattern":
    "知识库名称只能包含中文、英文、数字、空格、下划线和连字符",
  ...
  "feature.voiceClone.description":
    "使用AI技术克隆特定音色，实现个性化语音合成",
  "feature.knowledgeBase.name": "知识库",
  "feature.knowledgeBase.description":
    "构建和管理知识库系统，为AI助手提供专业知识支持",
  "feature.mcpAccessPoint.name": "MCP接入点",
  "feature.mcpAccessPoint.description":
    "提供MCP协议接入点，支持外部工具和服务的集成",
  ...
  // 网络请求相关
  "network.requestError": "网络请求出现了错误【{status}】",
  "network.cannotConnect": "似乎无法连接服务器",
  "network.connecting": "正在连接服务器({index})",
  "network.loginFailed": "登录失败",

  // 缓存查看器
  "cache.loadFailed": "加载缓存数据失败",

  // 验证码
  "captcha.loadFailed": "验证码加载失败，点击刷新",
  "captcha.loadError": "验证码加载异常",

  // 密码相关
  "password.copied": "密码已复制",
  "password.encryptFailed": "密码加密失败",

  // 文件上传
  "file.sizeExceeded": "文件大小不能超过10MB!",
  "file.selectRequired": "请选择要上传的文件",
  "file.batchUploadFailed": "批量上传失败",
  "file.parsingSubmitted": "请求已提交，解析中",
  "file.getSlicesFailed": "获取切片列表失败",

  // API相关
  "api.processingError": "处理响应时出错",
  "api.callError": "调用API时出错",
  "api.cloneFailed": "克隆失败，请将鼠标悬停在错误提示上，查看错误详情",
  "api.audioNotExist": "音频不存在",
  ...
  // JSON格式
  "json.formatError":
    '必须输入字典格式（如 {"key":"value"}），保存则使用原数据',

  // 知识库文件上传
  'knowledgeFileUpload.uploadSuccessCount': '成功上传 {count} 个文件',
  'knowledgeFileUpload.uploadFailedCount': '上传失败 {count} 个文件: {files}',

  // 声纹对话框
  'voicePrintDialog.addSpeaker': '添加说话人',
  'voicePrintDialog.descriptionRequired': '请输入描述',
  'voicePrintDialog.nameRequired': '请输入名称',
  'voicePrintDialog.audioVectorRequired': '请选择音频向量',

  // 参数对话框
  'paramDialog.addParam': '新增参数',

  // 模型编辑对话框
  'modelEditDialog.jsonFormatError': '必须输入字典格式（如 {"key":"value"}），保存则使用原数据',

  // 复制相关
  'copy.failed': '复制失败，请手动复制',

  // 查看密码对话框
  'viewPasswordDialog.newPassword': '用户新密码',
  'viewPasswordDialog.newPasswordLabel': '用户新密码',
  'viewPasswordDialog.close': '关闭',
  ...
  // 供应商管理
  'providerManagement.getParamsListFailed': '获取参数列表失败',
